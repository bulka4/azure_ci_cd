# Retrieve metadata about the currently authenticated Azure client — i.e., the identity Terraform is using to interact with Azure
# From this we will get a Tenant ID in outputs.
